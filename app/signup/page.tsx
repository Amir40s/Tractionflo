import { signup, signupWithGoogle } from '../login/actions'
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-6">
          <div className="w-full max-w-[480px] bg-white rounded-[1.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-6 sm:p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-[28px] font-extrabold text-foreground mb-2">Create an Account</h2>
            ...
            <form className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-1 pb-3">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-success focus:ring-success cursor-pointer" required />
                  <span className="text-sm font-semibold text-foreground-muted">I agree to the Terms & Conditions</span>
                </label>
              </div>
              ...
              <button
                ...
                formNoValidate
                className="w-full bg-white border border-gray-200 hover:bg-gray-50 text-black font-bold py-3.5 px-4 rounded-xl transition-all shadow-sm flex justify-center items-center gap-3 text-sm"
              >
